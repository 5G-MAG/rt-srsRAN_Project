...
inline e1ap_mbs_ngu_information_at_5gc asn1_to_mbs_ngu_info_at_5gc(asn1::e1ap::mb_sn_gu_info_at5_gc_c asn1_mbs_ngu_info_at_5gc)
{
  ...
  if (asn1_mbs_ngu_info_at_5gc.type() == asn1::e1ap::mb_sn_gu_info_at5_gc_c::types::multicast) {
    ...
    mbs_ngu_info_at_5gc.ip_multicast_address = transport_layer_address::create_from_bitstring(multicast_choice.ipmc_address.to_string());

    // Fill IP Source Address (M).
    mbs_ngu_info_at_5gc.ip_source_address = transport_layer_address::create_from_bitstring(multicast_choice.ipsource_address.to_string());
